...
func TestV3BehaviorContractCoversHostSurface(t *testing.T) {
	...
	for _, method := range []string{
		...
		"ThreadReader.Bootstrap", "ThreadReader.Snapshot", "ThreadReader.Subscribe", "ThreadReader.ReadOverview",
		...
		"TurnExecutor.StartTurn", "TurnExecutor.AdmitTurn", "TurnExecutor.ExecuteAdmission",
		"TurnExecutor.RetryTurn", "TurnExecutor.ContinuePendingTool", "TurnExecutor.RecordPendingToolOutcome",
		"TurnExecutor.ResolveApproval", "TurnExecutor.UpdateTodos",
		"SubAgentManager.SpawnSubAgent", "SubAgentManager.SendSubAgentMessage", "SubAgentManager.InterruptSubAgent",
		"SubAgentManager.WaitSubAgents", "SubAgentManager.CloseSubAgent",
