...
import (
	...
	sessioncompaction "github.com/floegence/floret/v5/internal/session/compaction"
...
func TestProviderSummaryRetriesAfterTruncationWithHalfCap(t *testing.T) {
	...
	retryPromptInput := contextpolicy.EstimateMessageContext("", scripted.Requests[1].Messages, policy).InputTokens
...
func TestProviderSummaryRetriesOverBudgetThenTrims(t *testing.T) {
	...
	if got := contextpolicy.EstimateTextTokens(prep.Result.Summary); got > policy.ReservedSummaryTokens {
