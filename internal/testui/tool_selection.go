...
func selectedToolsForLegacyMode(mode string) []string {
	...
	case "network":
		return []string{builtintools.ToolRead, builtintools.ToolList, builtintools.ToolGlob, builtintools.ToolGrep, builtintools.ToolApplyPatch, builtintools.ToolEdit, builtintools.ToolWrite, builtintools.ToolShell, builtintools.ToolWebFetch}
	default:
		return nil
	}
}

func registerAgentSessionTools(registry *tools.Registry, root string, selected []string) error {
