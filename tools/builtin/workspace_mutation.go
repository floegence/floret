...
func applyPatchTool(opts WorkspaceOptions) tools.Tool {
	return tools.Define[applyPatchArgs](
		tools.Definition{
			...
			OutputPolicy: tools.OutputPolicy{VisibleMaxBytes: 32 * 1024, VisibleMaxLines: 400, Strategy: tools.OutputHead, PreserveFull: true},
		},
		nil,
...
func writeTool(opts WorkspaceOptions) tools.Tool {
	return tools.Define[writeArgs](
		tools.Definition{
			...
			Destructive:  true,
			Permission:   tools.PermissionSpec{Mode: tools.PermissionAsk, ResourceKinds: []string{"file"}},
			OutputPolicy: tools.OutputPolicy{VisibleMaxBytes: 8 * 1024, VisibleMaxLines: 100, Strategy: tools.OutputHead, PreserveFull: true},
		},
		nil,
