...
readonly version="v7.0.5-candidate"
...
readonly adoption_root=$(mktemp -d "${TMPDIR:-/tmp}/floret-v7-candidate.XXXXXX")
cleanup() {
...
go mod init example.com/floret-v7-candidate-adoption
