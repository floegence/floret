...
readonly version="v6.0.0-candidate"
...
readonly adoption_root=$(mktemp -d "${TMPDIR:-/tmp}/floret-v6-candidate.XXXXXX")
cleanup() {
...
go mod init example.com/floret-v6-candidate-adoption
