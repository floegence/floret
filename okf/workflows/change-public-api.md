---
type: Workflow
title: Change The V6 Public API
description: Review and verify deliberate changes to exported v6 contracts.
resource: /internal/architecture/testdata/v6-public-api.txt
tags: [workflow, api, compatibility]
timestamp: 2026-07-29T00:00:00Z
---

# Change The V6 Public API
...
5. Make an explicit design decision, then update the generated v6 API
   baseline, symbol decision matrix, behavior contract, README, OKF, and changelog.
6. Run the v6 `go/types` baseline test and the blank-module adoption gate.
   After v6.0.0, incompatible changes require the next major version.
