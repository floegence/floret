---
type: Workflow
title: Change The V4 Public API
description: Review and verify deliberate changes to exported v4 contracts.
resource: /internal/architecture/testdata/v4-public-api.txt
tags: [workflow, api, compatibility]
timestamp: 2026-07-29T00:00:00Z
---

# Change The V4 Public API
...
5. Make an explicit design decision, then update the generated v4 API
   baseline, symbol decision matrix, behavior contract, README, OKF, and changelog.
6. Run the v4 `go/types` baseline test and the blank-module adoption gate.
   After v4.0.0, incompatible changes require the next major version.
